...
function pdfOptions(){
    ...
    this.options.pdf.summary = {
        headerTemplate: "<p id='ebook-header' style='border-bottom: 1px solid black; margin-top: 36pt;'><span class='odd_page'><span>Alura</span><span style='float:right'>Sumário</span></span><span class='even_page'><span>Sumário</span><span style='float:right'>Alura</span></span></p>",
        footerTemplate: null
    };
}
